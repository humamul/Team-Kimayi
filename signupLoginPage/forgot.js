let facebook = document.querySelector("#forgotPassword>div:nth-child(2)");
...
let google = document.querySelector("#forgotPassword>div:nth-child(3)");
...
let reset = document.querySelector("#buttons>button:first-child");
